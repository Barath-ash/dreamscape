      ...
      <div class="font-[sans-serif] bg-white p-4 lg:max-w-7xl max-w-xl mx-auto">
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <img src="" alt="" />
            ...
            <div class="flex flex-wrap gap-4 text-sm font-bold border-t-2 pt-4 mt-4">
        ...
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <ul class="text-gray-800 mt-8 space-y-4">
            ...
            Travel Booking  <span class="ml-auto font-bold">$150.00</span>
            </li>
            <li class="flex flex-wrap gap-4 text-sm">
              Food <span class="ml-auto font-bold">$200.00</span>
            </li>
            <li class="flex flex-wrap gap-4 text-sm">
            Room Arrangement <span class="ml-auto font-bold">$300.00</span>
            </li>
            <li class="flex flex-wrap gap-4 text-sm">
